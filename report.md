...
- family and endpoint insights toggle inline in-place (no page jumps, no detached inspector panel)
- grouped deviations and deviation counts use plain-language labels (no “instances” ambiguity)
